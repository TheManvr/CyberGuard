...
8. ผู้ใช้พิมพ์ `ค้นเพิ่ม` พร้อมลิงก์เพื่อค้นข้อมูลชื่อเว็บจากแหล่งภายนอกได้
9. AI รวมหลักฐานและจำแนกเนื้อหาเป็นเว็บพนัน เว็บขโมยข้อมูล เว็บเลียนแบบ scam หรือประเภทอื่น
10. บอตตอบด้วยหัวข้อและคำแนะนำสั้น ๆ สำหรับผู้สูงอายุ และส่งภาพประกอบเมื่อเว็บไซต์มีภาพ HTTPS ที่ผ่านเงื่อนไข
